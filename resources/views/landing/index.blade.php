...
@section('meta_description', 'BeautyCare adalah aplikasi manajemen bisnis kecantikan untuk Salon, Spa, Nail Art,
        ...
        <div class="testimoni-slider animate-on-scroll">
            <div class="testimoni-track">
                <div class="testimoni-card">
                    ...
                    <div class="author">
                        <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=96&q=80" alt="Sarah"
                            loading="lazy">
                        <div>
                            <h4>Sarah Wijaya</h4>
                ...
                <div class="testimoni-card">
                    ...
                    <div class="author">
                        <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=96&q=80" alt="Rudi"
                            loading="lazy">
                        <div>
                            <h4>Rudi Hartono</h4>
                ...
                <div class="testimoni-card">
                    ...
                    <div class="author">
                        <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=96&q=80" alt="Dian"
                            loading="lazy">
                        <div>
                            <h4>Dian Permata</h4>
                ...
                <div class="testimoni-card">
                    ...
                    <p class="comment">"Support tim BeautyCare sangat responsif. Setiap ada kendala langsung dibantu.
                        Pelayanan prima!"</p>
                    <div class="author">
                        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=96&q=80" alt="Andi"
                            loading="lazy">
                        <div>
                            <h4>Andi Pratama</h4>
                ...
                <div class="testimoni-card">
                    ...
                    <div class="author">
                        <img src="https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=96&q=80" alt="Maya"
                            loading="lazy">
                        <div>
            ...
            <div class="contact-form">
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="contact-message" class="form-input" placeholder="Tulis pesan Anda..."
                            required></textarea>
                    </div>
