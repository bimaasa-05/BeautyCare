...
@section('meta_description', 'BeautyCare adalah aplikasi manajemen bisnis kecantikan untuk Salon, Spa, Nail Art, Barbershop, Eyelash, dan Skincare. Kelola bisnis Anda dengan lebih mudah.')
    ...
    <div class="container">
        <div class="hero-content">
            <span class="badge badge-primary">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right:6px;"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
                Platform Manajemen #1 di Indonesia
            </span>
            <h1>Kelola Bisnis Kecantikan Anda dengan <span>Lebih Mudah</span></h1>
            <p>BeautyCare membantu Anda mengelola salon, spa, nail art, barbershop, dan skincare dalam satu platform terintegrasi. Hemat waktu, tingkatkan pendapatan.</p>
        ...
        <div class="hero-image">
            <div class="mockup">
                <img src="{{ asset('assets/images/dashboard/dashboard-preview.png') }}" alt="BeautyCare Dashboard Preview" loading="lazy">
            </div>
    ...
    <div class="container">
        <div class="about-grid animate-on-scroll">
            <div class="about-image">
                <img src="https://images.unsplash.com/photo-1560066984-138dadb4c035?w=600&q=80" alt="Tentang BeautyCare" loading="lazy">
            ...
            <div class="about-content">
                ...
                <p>BeautyCare adalah platform manajemen bisnis kecantikan yang dirancang khusus untuk membantu para pelaku bisnis di industri kecantikan mengelola operasional sehari-hari dengan lebih efisien dan profesional.</p>
                <ul class="about-list">
                    <li>
    ...
    <div class="container">
        ...
        <div class="features-grid stagger-container">
            ...
            <div class="feature-card stagger-item">
                ...
                <h3>Chat</h3>
                <p>Komunikasi internal tim dan dengan pelanggan dalam satu platform.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="keunggulan-grid animate-on-scroll">
            <div class="keunggulan-image">
                <img src="https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=600&q=80" alt="BeautyCare Keunggulan" loading="lazy">
            </div>
    ...
    <div class="container">
        ...
        <div class="layanan-grid animate-on-scroll">
            <div class="layanan-card">
                <img src="https://images.unsplash.com/photo-1560750588-73207b1ef5b8?w=400&q=80" alt="Salon" loading="lazy">
                <div class="overlay">
                    <h3>Salon</h3>
            ...
            <div class="layanan-card">
                <img src="https://images.unsplash.com/photo-1540555700478-4be289fbec6d?w=400&q=80" alt="Spa" loading="lazy">
                <div class="overlay">
                    <h3>Spa & Wellness</h3>
            ...
            <div class="layanan-card">
                <img src="https://images.unsplash.com/photo-1610992015732-2449b76344bc?w=400&q=80" alt="Nail Art" loading="lazy">
                <div class="overlay">
                    <h3>Nail Art</h3>
            ...
            <div class="layanan-card">
                <img src="https://images.unsplash.com/photo-1599351431202-1e0f5e07a6ea?w=400&q=80" alt="Barbershop" loading="lazy">
                <div class="overlay">
                    <h3>Barbershop</h3>
            ...
            <div class="layanan-card">
                <img src="https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=400&q=80" alt="Skincare" loading="lazy">
                <div class="overlay">
            ...
            <div class="layanan-card">
                <img src="https://images.unsplash.com/photo-1583001931096-959e9a1a6223?w=400&q=80" alt="Eyelash" loading="lazy">
                <div class="overlay">
                    <h3>Eyelash & Brow</h3>
        ...
        <div class="testimoni-slider animate-on-scroll">
            <div class="testimoni-track">
                <div class="testimoni-card">
                    <div class="stars">★★★★★</div>
                    <p class="comment">"BeautyCare benar-benar mengubah cara saya mengelola salon. Booking online, POS, dan laporan keuangan jadi sangat mudah. Recommended!"</p>
                    <div class="author">
                        <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=96&q=80" alt="Sarah" loading="lazy">
                        <div>
                            <h4>Sarah Wijaya</h4>
                ...
                <div class="testimoni-card">
                    <div class="stars">★★★★★</div>
                    <p class="comment">"Fitur membership dan promo sangat membantu meningkatkan loyalitas pelanggan. Pendapatan naik 40% sejak pakai BeautyCare!"</p>
                    <div class="author">
                        <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=96&q=80" alt="Rudi" loading="lazy">
                        <div>
                            <h4>Rudi Hartono</h4>
                ...
                <div class="testimoni-card">
                    <div class="stars">★★★★★</div>
                    <p class="comment">"Dashboard analytics-nya sangat lengkap. Saya bisa memantau semua cabang dalam satu layar. Luar biasa!"</p>
                    <div class="author">
                        <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=96&q=80" alt="Dian" loading="lazy">
                        <div>
                            <h4>Dian Permata</h4>
                ...
                <div class="testimoni-card">
                    <div class="stars">★★★★★</div>
                    <p class="comment">"Support tim BeautyCare sangat responsif. Setiap ada kendala langsung dibantu. Pelayanan prima!"</p>
                    <div class="author">
                        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=96&q=80" alt="Andi" loading="lazy">
                        <div>
                            <h4>Andi Pratama</h4>
                ...
                <div class="testimoni-card">
                    <div class="stars">★★★★★</div>
                    <p class="comment">"Aplikasi sangat intuitif dan mudah digunakan. Tim kami tidak butuh waktu lama untuk beradaptasi. Recommended banget!"</p>
                    <div class="author">
                        <img src="https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=96&q=80" alt="Maya" loading="lazy">
                        <div>
    ...
    <div class="container">
        ...
        <div class="pricing-grid animate-on-scroll">
            <div class="pricing-card">
                ...
                <div class="price">Rp149<span>/bln</span></div>
            ...
            <div class="pricing-card featured">
                ...
                <div class="price">Rp349<span>/bln</span></div>
                <div class="price-period">Ditagih bulanan</div>
                <ul class="plan-features">
            ...
            <div class="pricing-card">
                ...
                <div class="price">Rp749<span>/bln</span></div>
                <div class="price-period">Ditagih bulanan</div>
                <ul class="plan-features">
            ...
            <div class="faq-item active">
                ...
                <div class="faq-answer">
                    <div class="faq-answer-inner">
                        BeautyCare adalah platform manajemen bisnis kecantikan all-in-one yang membantu Anda mengelola salon, spa, nail art, barbershop, skincare, dan eyelash dalam satu sistem terintegrasi.
                    </div>
                </div>
            </div>
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <div class="faq-answer-inner">
                        Ya, BeautyCare menawarkan masa trial gratis selama 14 hari tanpa komitmen. Anda bisa mencoba semua fitur premium selama masa trial.
                    </div>
                </div>
            </div>
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <div class="faq-answer-inner">
                        BeautyCare dapat diakses melalui browser di perangkat apa pun (desktop, tablet, maupun smartphone). Tampilan kami sudah responsive di semua ukuran layar.
                    </div>
                </div>
            </div>
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <div class="faq-answer-inner">
                        Keamanan adalah prioritas utama kami. Semua data dienkripsi menggunakan SSL/TLS, disimpan di server aman, dan kami melakukan backup data secara rutin.
                    </div>
                </div>
            </div>
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <div class="faq-answer-inner">
                        Untuk paket Enterprise, kami menyediakan layanan kustomisasi fitur sesuai kebutuhan spesifik bisnis Anda. Silakan hubungi tim kami untuk diskusi lebih lanjut.
                    </div>
                </div>
            </div>
        </div>
                ...
                <form>
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="contact-name" class="form-input" placeholder="Nama lengkap" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="contact-email">Email</label>
                            <input type="email" id="contact-email" class="form-input" placeholder="email@example.com" required>
                        </div>
                    </div>
                    <div class="form-group">
