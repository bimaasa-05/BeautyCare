        ...
        <main class="main-content keranjang-main">
            ...
            <div class="dashboard-content">
                ...
                @if ($troli->count() > 0)
                    <div class="keranjang-tools">
                        ...
                        <div class="kt-actions">
                            ...
                            <button class="btn-hapus-sebagian" id="btnBatalHapus" onclick="toggleHapusMode()"
                                style="display: none;">
                                ...
                                <div class="kc-divider"></div>
                                    ...
                                    <div class="kc-qty-row">
                                        ...
                                        <div class="kc-subtotal">
                                            ...
                                            <div class="kcs-nominal" id="total-item-{{ $item->id }}">Rp
                                    ...
                                    <div class="kc-actions">
                                        <a href="{{ route('pelanggan.keranjang.detail', $item->id) }}"
                                            class="kc-btn-detail" title="Lihat detail keranjang">
                ...
                <div class="keranjang-empty" id="keranjangEmpty"
                    style="display: {{ $troli->count() > 0 ? 'none' : '' }};">
                    <div class="ke-icon">
    ...
    <div id="deleteModal" class="modal-premium">
        <div class="modal-box">
            <form id="deleteForm" method="POST">
                ...
                <p id="modalDeleteBody">Apakah Anda yakin ingin menghapus produk ini?<br>Tindakan ini tidak dapat
                    dibatalkan.</p>
    ...
    function formatAngka(n) {
        ...
        function confirmDelete(id) {
            ...
            document.getElementById('modalDeleteBody').innerHTML =
                'Apakah Anda yakin ingin menghapus produk ini?<br>Tindakan ini tidak dapat dibatalkan.';
        ...
        function confirmBatchDelete() {
            ...
            deleteMode = 'batch';
            document.getElementById('modalDeleteTitle').textContent = 'Hapus Produk';
            document.getElementById('modalDeleteBody').innerHTML = 'Apakah Anda yakin ingin menghapus ' + selected.length +
                ' produk ini?<br>Tindakan ini tidak dapat dibatalkan.';
            document.getElementById('deleteModal').classList.add('show');
        }
        ...
        function toggleHapusMode() {
            ...
            wraps.forEach(function(w) {
                w.classList.toggle('show', hapusMode);
            });
        ...
        function hitungHapus() {
            if (!hapusMode) return;
            var n = document.querySelectorAll('.cb-hapus:checked').length;
            var btn = document.getElementById('btnHapusSebagian');
            if (btn) {
                btn.innerHTML = n > 0 ?
                    '<i class="fa-solid fa-trash-can"></i> Hapus (' + n + ')' :
