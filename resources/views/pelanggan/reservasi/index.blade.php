...
<head>
    ...
    @media (max-width: 768px) {
        ...
        .reservasi-card .rc-header { flex-wrap: wrap; gap: 14px; }
        .reservasi-card .rc-header .rc-actions { width: 100%; }
        .reservasi-card .rc-header .rc-actions .search-input-wrap { flex: 1; }
        .reservasi-card .rc-header .rc-actions .search-input-wrap input,
        .reservasi-card .rc-header .rc-actions .search-input-wrap input:focus { width: 100%; }
