...
<body>
                            ...
                            <div class="fcp-grid">
                                <div class="fg-premium">
                                    ...
                                    <div class="date-field-wrap">
                                        <input type="date" name="tanggal" id="tanggalInput" class="fg-input" required min="{{ date('Y-m-d') }}" value="{{ $booking->tanggal }}">
                                ...
                                <div class="fg-premium">
                                    ...
                                    <select name="jam" id="jamSlot" class="fg-input" required>
                                        ...
                                        <option value="{{ $jam }}" {{ \Carbon\Carbon::parse($booking->jam)->format('H:i') == $jam ? 'selected' : '' }}>{{ \App\Support\BookingSlot::formatJamIndo($jam) }}</option>
                                        @endforeach
                                    </select>
                                    <div style="margin-top:6px;font-size:11px;color:var(--gray);">
    ...
    let dcpSelected = '{{ $booking->tanggal }}';
    ...
    function showCalendarSummary(day, count, data, isPast) {
        ...
        meta.textContent = 'Pilih tanggal untuk jadwal booking Anda';
        if (isPast) {
