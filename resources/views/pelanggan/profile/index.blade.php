...
<head>
    ...
    <title>Profile Saya - BeautyCare</title>
    ...
    .profile-card .pc-header .pc-icon {
        width: 36px;
        height: 36px;
        border-radius: 10px;
    ...
    .profile-card .pc-header .pc-title {
        font-size: 16px;
        font-weight: 700;
        color: var(--dark);
    }
    ...
    .avatar-section .avatar-wrap:hover .avatar-overlay {
        opacity: 1;
    }

    .avatar-section .avatar-overlay i {
        color: #fff;
        font-size: 24px;
    }

    .avatar-section .avatar-name {
        font-size: 18px;
        font-weight: 700;
        color: var(--dark);
        margin-bottom: 2px;
    ...
    .avatar-section .avatar-role {
        font-size: 12px;
        color: var(--gray);
        font-weight: 500;
    }

    .avatar-section .avatar-role .badge-role {
                ...
                <div class="page-header-premium">
                    <div class="ph-content">
                        <div class="ph-left">
                            ...
                            <div class="ph-text">
                                <h3>Profile Saya</h3>
                                <p>Kelola data diri dan pengaturan akun Anda</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="profile-card">
                            ...
                            <div class="pc-body">
                                <div class="avatar-section">
                                    <form id="fotoForm" action="{{ route('pelanggan.profile.update-foto') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="avatar-wrap" onclick="document.getElementById('fotoInput').click()">
                                            <img src="{{ auth()->user()->foto ? asset('storage/' . auth()->user()->foto) : 'https://ui-avatars.com/api/?name='.urlencode(auth()->user()->nama).'&background=FF4F87&color=fff&size=140' }}"
                            ...
                            <div class="pc-body" style="padding:8px 24px;">
                                <div class="info-row">
                                    ...
                                    <div class="ir-content">
                                        ...
                                        <div class="ir-value">{{ auth()->user()->email }}</div>
                                    </div>
                                </div>
                                <div class="info-row">
                                    ...
                                    <div class="ir-content">
                                        ...
                                        <div class="ir-value">{{ auth()->user()->no_hp ?? '-' }}</div>
                                    </div>
                                </div>
                                <div class="info-row">
                                    ...
                                    <div class="ir-content">
                                        <div class="ir-label">Bergabung</div>
