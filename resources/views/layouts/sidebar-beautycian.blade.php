...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-profile">
        ...
        <div class="sp-info">
            ...
            <span class="sp-badge">Beautycian</span>
        </div>
    </div>
    ...
    <nav class="sidebar-nav">
        <div class="nav-section">
            ...
            <a href="{{ route('beautycian.dashboard') }}" class="nav-item {{ request()->routeIs('beautycian.dashboard') ? 'active' : '' }}" title="Overview jadwal dan aktifitas treatment">
                <span class="nav-icon">
