...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <a href="{{ route('pelanggan.pesanan.index') }}" class="nav-item {{ request()->routeIs('pelanggan.pesanan*') ? 'active' : '' }}" title="Lihat pesanan online Anda">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" />
                        <polyline points="3.27 6.96 12 12.01 20.73 6.96" />
        ...
        <div class="nav-section">
            ...
            <a href="{{ route('pelanggan.laporan-masalah.index') }}"
                class="nav-item {{ request()->routeIs('pelanggan.laporan-masalah*') ? 'active' : '' }}"
