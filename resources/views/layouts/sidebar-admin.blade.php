...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <a href="{{ route('admin.laporan-masalah.index') }}"
                class="nav-item {{ request()->routeIs('admin.laporan-masalah*') ? 'active' : '' }}"
                title="Tangani laporan masalah dari pengguna">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
                ...
                Laporan Masalah
                @if (hitungLaporanBaru() > 0)
                <span class="nav-badge badge-primary">{{ hitungLaporanBaru() > 99 ? '99+' : hitungLaporanBaru() }}</span>
                @endif
            </a>
        </div>
    </nav>
