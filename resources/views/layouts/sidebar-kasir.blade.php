...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-profile">
        ...
        <div class="sp-info">
            ...
            <span class="sp-badge">Kasir</span>
        </div>
    </div>
    ...
    <nav class="sidebar-nav">
        <div class="nav-section">
            ...
            <a href="{{ route('kasir.dashboard') }}" class="nav-item {{ request()->routeIs('kasir.dashboard') ? 'active' : '' }}" title="Overview transaksi dan aktifitas kasir">
                <span class="nav-icon">
        ...
        <div class="nav-section">
            ...
            <a href="#" class="nav-item" title="Kelola reservasi pelanggan">
                <span class="nav-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <rect x="3" y="4" width="18" height="18" rx="2" ry="2" /><line x1="16" y1="2" x2="16" y2="6" />
                        <line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" />
