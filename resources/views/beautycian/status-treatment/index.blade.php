                            ...
                            <div class="kc-card-header">
                                ...
                                <div class="kc-header-right">
                                    <span class="done-badge">
                                        ...
                                        @php $jamMulaiAktual = $item->jam_mulai_aktual ?? $item->jam; @endphp
                                        @if($jamMulaiAktual)
                                        · Durasi {{ gmdate('H:i:s', max(0, \Carbon\Carbon::parse($item->jam_selesai_aktual)->diffInSeconds(\Carbon\Carbon::parse($jamMulaiAktual)))) }}
                                        @endif
                                    </span>
                                </div>
                                @endif
