            ...
            <div class="flex-1 overflow-y-auto p-8">
                <div class="bg-white rounded-2xl p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h3 class="text-[16px] font-bold text-gray-800">Riwayat Transaksi</h3>
                            <p class="text-[12px] text-gray-400 mt-0.5">Riwayat seluruh transaksi penjualan</p>
                        </div>
                                ...
                                <tr>
                                    <td colspan="8" class="py-10 text-center">
                                        <div class="flex flex-col items-center gap-2">
                                            <i class="fa-regular fa-rectangle-list text-4xl text-gray-300"></i>
                                            <p class="text-gray-400 font-medium text-[14px]">Belum ada riwayat transaksi</p>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
