                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="subtotal" id="subtotal"
                                    ...
                                    placeholder="0" value="{{ old('subtotal', $transaksi->subtotal) }}" min="0" oninput="hitungTotal()">
                                @error('subtotal')
                                    <p class="text-red-500 text-[11px] mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="diskon" id="diskon"
                                    ...
                                    placeholder="0" value="{{ old('diskon', $transaksi->diskon) }}" min="0" oninput="hitungTotal()">
                                @error('diskon')
                                    <p class="text-red-500 text-[11px] mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="pajak" id="pajak"
                                    ...
                                    placeholder="0" value="{{ old('pajak', $transaksi->pajak) }}" min="0" oninput="hitungTotal()">
                                @error('pajak')
                                    <p class="text-red-500 text-[11px] mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="total" id="total"
                                    ...
                                    placeholder="0" value="{{ old('total', $transaksi->total) }}" min="0" readonly>
                                @error('total')
                                    <p class="text-red-500 text-[11px] mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="dibayar" id="dibayar"
                                                ...
                                                placeholder="0" value="{{ old('dibayar', $transaksi->dibayar) }}" min="0" oninput="hitungKembali()">
                                            @error('dibayar')
                                                <p class="text-red-500 text-[11px] mt-1">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="form-group">
                                            ...
                                            <select name="bank_asal" id="ewallet_type"
                                                ...
                                                <option value="Dana" {{ old('bank_asal', $transaksi->bank_asal) == 'Dana' ? 'selected' : '' }}>Dana</option>
                                                <option value="GoPay" {{ old('bank_asal', $transaksi->bank_asal) == 'GoPay' ? 'selected' : '' }}>GoPay</option>
                                                <option value="OVO" {{ old('bank_asal', $transaksi->bank_asal) == 'OVO' ? 'selected' : '' }}>OVO</option>
                                                <option value="ShopeePay" {{ old('bank_asal', $transaksi->bank_asal) == 'ShopeePay' ? 'selected' : '' }}>ShopeePay</option>
                                            </select>
                                            @error('bank_asal')
                                                <p class="text-red-500 text-[11px] mt-1">{{ $message }}</p>
                                            @enderror
