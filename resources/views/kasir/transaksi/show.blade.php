                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    <div class="info-box">
                                        <p class="info-label"><i class="fa-solid fa-user mr-1 text-pink-300"></i>
                                            Pelanggan</p>
                                        <p class="info-value">{{ $transaksi->pelanggan->nm_pelanggan ?? '-' }}</p>
                                    </div>
                                    <div class="info-box">
                                        <p class="info-label"><i class="fa-solid fa-hashtag mr-1 text-pink-300"></i>
                                            No.
                                            Invoice</p>
                                    ...
                                    <div class="info-box">
                                        <p class="info-label"><i
                                                class="fa-solid fa-calendar mr-1 text-pink-300"></i>
                                            Tanggal</p>
                                        <p class="info-value">
                                    ...
                                    <div class="info-box">
                                        <p class="info-label"><i
                                                class="fa-solid fa-credit-card mr-1 text-pink-300"></i>
                                            Metode</p>
                                        <p class="info-value">{{ $transaksi->metode_byr }}</p>
                                    </div>
                                    <div class="info-box">
                                        <p class="info-label"><i
                                                class="fa-solid fa-money-bill-1 mr-1 text-pink-300"></i> Subtotal</p>
                                    ...
                                    <div class="info-box">
                                        <p class="info-label"><i
                                                class="fa-solid fa-money-bill-wave mr-1 text-pink-300"></i> Diskon
                                        </p>
                                        <p class="info-value text-red-500">- Rp
                                            {{ number_format($transaksi->diskon, 0, ',', '.') }}</p>
                                    </div>
                                    <div class="info-box">
                                        <p class="info-label"><i class="fa-solid fa-percent mr-1 text-pink-300"></i>
                                            Pajak</p>
                                        <p class="info-value">+ Rp {{ number_format($transaksi->pajak, 0, ',', '.') }}
                                        </p>
                                    </div>
                                    <div class="info-box">
                                        <p class="info-label"><i class="fa-solid fa-coins mr-1 text-pink-300"></i>
                                            Total
                                        </p>
                                    ...
                                    <div class="info-box">
                                        <p class="info-label"><i
                                                class="fa-solid fa-money-bill-1 mr-1 text-pink-300"></i> Dibayar</p>
                                    ...
                                    <div class="info-box md:col-span-2">
                                        <p class="info-label"><i
                                                class="fa-solid fa-note-sticky mr-1 text-pink-300"></i>
                                            Catatan</p>
