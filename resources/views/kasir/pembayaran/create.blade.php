                        ...
                        <div class="p-4 bg-gradient-to-br from-pink-50 to-white rounded-xl border border-pink-100">
                            ...
                            <div class="overflow-x-auto"><table class="w-full text-[13px] table-card-mobile">
                                ...
                                <tr>
                                    ...
                                    <td data-label="" class="py-1.5 text-gray-700">{{ \Carbon\Carbon::parse($booking->tanggal)->isoFormat('dddd, D MMMM YYYY') }}</td>
                                </tr>
                                @php
                                    $durasiMenit = \App\Support\BookingSlot::durasiBooking($booking);
                                    $jamMulai = \Carbon\Carbon::parse($booking->jam)->format('H:i');
                            ...
                            <div class="overflow-x-auto"><table class="w-full text-[13px] table-card-mobile">
                                <thead>
                                    <tr class="border-b border-emerald-100">
                                        ...
                                        <th class="text-center py-2 text-[11px] font-semibold text-gray-400">Durasi</th>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="4" class="py-3 text-right text-[13px] font-bold text-gray-600">Total</td>
