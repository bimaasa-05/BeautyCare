                ...
                <main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
                    <div class="space-y-5">
                        ...
                        <div class="flex items-center justify-between flex-wrap gap-3">
                            <div class="flex items-center gap-2">
                                ...
                                @foreach ($periodes as $key => $label)
                                    <a href="{{ route('kasir.laporan-pelanggan.index', ['periode' => $key]) }}"
                            ...
                            <div class="flex gap-2">
                                <a href="{{ route('kasir.laporan-pelanggan.export-pdf', ['periode' => $periode]) }}"
                                ...
                                <a href="{{ route('kasir.laporan-pelanggan.export-excel', ['periode' => $periode]) }}"
                                    class="flex items-center gap-1.5 px-3 py-2 border border-pink-100 bg-white rounded-xl text-xs text-gray-600 hover:border-pink-300 font-bold">
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-[0_2px_16px_rgba(236,72,153,0.07)] border border-pink-50">
                            ...
                            <form method="GET" action="{{ route('kasir.laporan-pelanggan.index') }}" class="flex flex-wrap items-center justify-end gap-2 mb-4 filter-bar">
                                ...
                                @if ($search || $dari || $sampai)
                                    <a href="{{ route('kasir.laporan-pelanggan.index', ['periode' => $periode]) }}"
