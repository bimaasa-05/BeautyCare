...
<head>
    ...
    <style>
        ...
        .form-group .form-control { width: 100%; padding: 11px 16px; border-radius: 12px; border: 1.5px solid var(--border); background: #FAFAFA; font-size: 13px; font-family: var(--font-primary); color: var(--dark); transition: all 0.2s ease; outline: none; }
        ...
        .btn-primary-full { width: 100%; padding: 12px 24px; border-radius: 12px; border: none; background: linear-gradient(135deg, var(--primary), #FF7BA6); color: #fff; font-size: 13px; font-weight: 600; cursor: pointer; transition: all 0.3s ease; font-family: var(--font-primary); box-shadow: 0 4px 16px rgba(255, 79, 135, 0.25); }
        .btn-primary-full:hover { transform: translateY(-2px); box-shadow: 0 6px 24px rgba(255, 79, 135, 0.35); }
        .btn-outline { display: inline-flex; align-items: center; justify-content: center; gap: 8px; padding: 10px 24px; border-radius: 12px; border: 1.5px solid var(--border); background: var(--white); color: var(--gray); font-size: 13px; font-weight: 600; cursor: pointer; transition: all 0.2s ease; font-family: var(--font-primary); }
                ...
                <div class="profile-grid">
                        ...
                        <div class="profile-card">
                            ...
                            <div class="pc-body">
                                <div class="avatar-section">
                                    <form id="fotoForm" action="{{ route('kasir.profile.update-foto') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                    ...
                    <div>
                        ...
                        <div class="profile-card" style="margin-top:24px;">
                            ...
                            <div class="pc-body">
                                <form action="{{ route('kasir.profile.update-password') }}" method="POST">
                                    @csrf
                                    <div class="form-group">
