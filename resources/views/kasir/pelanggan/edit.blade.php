        ...
        <main class="main-content">
            ...
            <div class="flex-1 overflow-y-auto p-8">
                <div class="bg-white rounded-2xl p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] relative overflow-hidden">
                    <div style="position:absolute;pointer-events:none;opacity:0.08;font-size:70px;top:-5px;right:-5px;">✏️</div>
                    ...
                    <form action="{{ route('kasir.pelanggan.update', $pelanggan->id_pelanggan) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_member" class="form-input @error('id_member') border-red-400 @enderror">
                                    <option value="">-- Pilih Member --</option>
                                    @foreach($memberships as $member)
                                        <option value="{{ $member->id_member }}"
                                            {{ old('id_member', $pelanggan->id_member) == $member->id_member ? 'selected' : '' }}>
                            ...
                            <div class="form-group md:col-span-2">
                                ...
                                <textarea name="alamat" rows="3"
                                    class="form-input @error('alamat') border-red-400 @enderror"
                            ...
                            <div class="form-group md:col-span-2">
                                ...
                                <textarea name="catatan_alergi" rows="3"
                                    class="form-input @error('catatan_alergi') border-red-400 @enderror"
                                    placeholder="Catatan alergi (jika ada)">{{ old('catatan_alergi', $pelanggan->catatan_alergi) }}</textarea>
