                    ...
                    <div class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div class="bg-white rounded-2xl p-5 shadow-[0_2px_16px_rgba(239,68,68,0.08)] border border-red-50 hover:shadow-[0_4px_24px_rgba(239,68,68,0.14)] transition-all duration-300">
                                <div class="flex items-start justify-between mb-4">
                                    <div class="w-11 h-11 rounded-xl bg-gradient-to-br from-red-400 to-rose-600 flex items-center justify-center shadow-sm">
                                    ...
                                    <span class="flex items-center gap-1 text-[10px] font-semibold px-2 py-1 rounded-full text-red-600 bg-red-50">
                                        <i data-lucide="arrow-down" class="w-3 h-3"></i>Pengeluaran
                                    </span>
                                </div>
                                <p class="text-sm text-gray-400 font-medium mb-1">Pengeluaran Pembelian</p>
                                <p class="text-2xl font-bold text-red-600">{{ $fmt($totalPengeluaran) }}</p>
