                ...
                <div class="ph-content">
                    <div class="ph-left">
                        ...
                        <div class="ph-text">
                            ...
                            <p>Buat paket membership baru untuk pelanggan.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form id="membershipForm" action="{{ route('admin.membership.store') }}" method="POST">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <input type="number" name="diskon" value="{{ (float) old('diskon', 0) }}" step="0.01" min="0" max="100"
                            ...
                            <div>
                                ...
                                <input type="hidden" name="harga" id="hargaHidden" value="{{ old('harga', 0) }}">
                                @error('harga')
                                    <p class="text-red-500 text-[11px] mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" inputmode="numeric" name="masa_berlaku" value="{{ old('masa_berlaku') }}"
                                    data-format-number
