...
<head>
    ...
    <title>Edit Kategori - BeautyCare</title>
            ...
            <div class="page-header-premium">
                <div class="ph-content">
                    <div class="ph-left">
                        ...
                        <div class="ph-text">
                            <h3>Edit Kategori</h3>
                            <p>Ubah informasi kategori yang sudah ada.</p>
                        </div>
                    </div>
                </div>
            </div>
                <div class="bg-white rounded-2xl p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h3 class="text-[16px] font-bold text-gray-800">
                                Edit {{ $type === 'layanan' ? 'Kategori Layanan' : 'Kategori Produk' }}
                            </h3>
                            <p class="text-[12px] text-gray-400 mt-0.5">Ubah data kategori</p>
                        </div>
                    ...
                    <form action="{{ route('admin.kategori.update', $type === 'layanan' ? $kategori->id_kategori_layanan : $kategori->id_kategori_produk) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        @if ($type === 'layanan')
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <input type="text" name="nm_layanan" value="{{ old('nm_layanan', $kategori->nm_layanan) }}"
                                ...
                                <div>
                                    ...
                                    <select name="status"
                                        ...
                                        <option value="belum_tersedia" {{ old('status', $kategori->status) == 'belum_tersedia' ? 'selected' : '' }}>Belum Tersedia</option>
                                    </select>
                                    @error('status')
                                        <p class="text-red-500 text-[11px] mt-1">{{ $message }}</p>
                                    @enderror
                        ...
                        @else
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <input type="text" name="nm_produk" value="{{ old('nm_produk', $kategori->nm_produk) }}"
