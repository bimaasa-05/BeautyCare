                ...
                <div class="bg-white rounded-2xl p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]">
                    ...
                    <form action="{{ route('admin.produk.update', $produk->id_produk) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="harga_jual" value="{{ old('harga_jual', $produk->harga_jual !== null ? rtrim(rtrim(number_format((float) $produk->harga_jual, 2, '.', ''), '0'), '.') : '') }}"
                        ...
                        <div class="mt-5 bg-[#FFF7FA] border border-pink-100 rounded-xl px-4 py-3 flex items-center gap-2 text-[12px] text-gray-500">
                            ...
                            Stok saat ini: <b class="text-gray-700">{{ $produk->stok }}</b>. Tambah stok melalui menu
