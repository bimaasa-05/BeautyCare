...
<head>
    ...
    <title>Tambah Karyawan - BeautyCare</title>
            ...
            <div class="page-header-premium">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h3 class="text-[16px] font-bold text-gray-800">Tambah Karyawan</h3>
                            <p class="text-[12px] text-gray-400 mt-0.5">Buat data karyawan baru</p>
                        </div>
