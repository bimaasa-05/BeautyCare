...
<head>
    ...
    <title>Edit Bank - BeautyCare</title>
                ...
                <div class="ph-content">
                    <div class="ph-left">
                        ...
                        <div class="ph-text">
                            ...
                            <p>Perbarui informasi rekening bank untuk pembayaran transfer</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] relative overflow-hidden">
                ...
                <div class="flex flex-wrap items-start sm:items-center justify-between gap-3 mb-6">
                    <div>
                        <h3 class="text-[16px] font-bold text-gray-800">
                            <i class="fa-solid fa-building-columns text-blue-500 mr-2"></i>Form Edit Bank
                        </h3>
                        <p class="text-[12px] text-gray-400 mt-0.5">
                            <i class="fa-solid fa-circle-info text-pink-300 mr-1"></i>Perbarui data bank dengan lengkap
                        </p>
                    </div>
                ...
                <form action="{{ route('admin.bank.update', $bank->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_bank"
                                ...
                                placeholder="Contoh: BCA, BRI, Mandiri" value="{{ old('nama_bank', $bank->nama_bank) }}">
                            @error('nama_bank')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_bank" maxlength="3"
                                ...
                                placeholder="Contoh: 014" value="{{ old('kode_bank', $bank->kode_bank) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                        <div class="form-group">
                            ...
                            <input type="text" name="atas_nama"
                                ...
                                placeholder="Contoh: BeautyCare Official" value="{{ old('atas_nama', $bank->atas_nama) }}">
                            @error('atas_nama')
                                <p class="text-red-500 text-[11px] mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_rekening"
                                ...
                                placeholder="Contoh: 1234567890" value="{{ old('no_rekening', $bank->no_rekening) }}">
                            @error('no_rekening')
                                <p class="text-red-500 text-[11px] mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div class="form-group">
                                ...
                                <select name="tipe" class="form-input-custom @error('tipe') border-red-400 @enderror">
                                    <option value="transfer" {{ old('tipe', $bank->tipe) == 'transfer' ? 'selected' : '' }}>Transfer (Virtual Account)</option>
                                    <option value="ewallet" {{ old('tipe', $bank->tipe) == 'ewallet' ? 'selected' : '' }}>E-Wallet</option>
                                    <option value="qris" {{ old('tipe', $bank->tipe) == 'qris' ? 'selected' : '' }}>QRIS</option>
                                </select>
                                @error('tipe')
                                    <p class="text-red-500 text-[11px] mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nomor_telepon"
                                    ...
                                    placeholder="+628xx-xxxx-xxxx" value="{{ old('nomor_telepon', $bank->nomor_telepon) }}">
                        ...
                        <div class="flex items-center gap-4 mt-4">
                            <div class="form-check">
                                ...
                                <input type="checkbox" name="is_active" id="is_active"
                                    ...
                                    {{ old('is_active', $bank->is_active) ? 'checked' : '' }} value="1">
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="flex items-center gap-3">
                                    <img id="logoPreview" 
                                        src="{{ $bank->logo ? asset('storage/' . $bank->logo) : asset('assets/img/bank-placeholder.svg') }}" 
                                        alt="Preview Logo" class="preview-logo">
                        ...
                        @if ($bank->logo)
                        <div class="mt-3 p-3 bg-amber-50 border border-amber-100 rounded-lg flex items-center gap-3 text-sm text-amber-800">
                            <i class="fa-solid fa-triangle-exclamation"></i>
                            <span>Bank ini sudah memiliki logo. Upload logo baru akan menggantikan logo lama.</span>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-100 flex flex-wrap items-center justify-between gap-4">
                        ...
                        <button type="submit"
                            ...
                            <i class="fa-regular fa-circle-check"></i> Perbarui Data Bank
                        </button>
                    </div>
                </form>
            </div>
