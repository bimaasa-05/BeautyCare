                    ...
                    <form action="{{ route('admin.transaksi.update', $transaksi->id_transaksi) }}" method="POST" enctype="multipart/form-data" onsubmit="stopPaymentTimer()">
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-100">
                            ...
                            <div id="item-container">
                                ...
                                <div class="item-row flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 mb-3 p-3 bg-gray-50 rounded-xl border border-gray-100" data-index="{{ $loop->index }}">
