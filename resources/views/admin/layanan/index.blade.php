                        ...
                        <div class="ph-icon-wrap">
                            <span class="nav-icon">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M12 3l1.912 5.813a2 2 0 0 0 1.9 1.375h5.813l-4.7 3.413a2 2 0 0 0-.726 2.236l1.912 5.812-4.7-3.412a2 2 0 0 0-2.35 0l-4.7 3.412 1.912-5.812a2 2 0 0 0-.726-2.236L2.375 10.19h5.813a2 2 0 0 0 1.9-1.375z"></path>
                                </svg>
                            </span>
                        </div>
                        <div class="ph-text">
                            <h3>Data Layanan</h3>
                            <p>Kelola layanan kecantikan yang ditawarkan oleh BeautyCare.</p>
                        </div>
                    </div>
                </div>
            </div>
