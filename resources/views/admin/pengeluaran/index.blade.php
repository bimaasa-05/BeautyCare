            ...
            <div class="flex-1 overflow-y-auto p-8">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] relative overflow-hidden mb-5">
                    <div class="mb-5">
                        ...
                        <p class="text-[12px] text-gray-400 mt-0.5">Kelola semua data pengeluaran seluruh kasir</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-5">
                        ...
                        <div class="rounded-xl p-4 bg-gradient-to-br from-pink-50 to-rose-50 border border-pink-100">
                            ...
                            <p class="text-[22px] font-bold text-pink-600 mt-1">{{ $totalKasir }} catatan</p>
                        </div>
                    </div>

                    <div class="flex flex-col md:flex-row md:items-center gap-3 mb-5">
                        <form action="{{ route('admin.pengeluaran.index') }}" method="GET" class="flex flex-col md:flex-row gap-3 flex-1">
                        ...
                        <table class="w-full text-[13px]">
                            <thead>
                                <tr class="border-b border-gray-100 text-[11px] uppercase tracking-wider text-gray-400">
                                    ...
                                    <th class="text-left py-3 px-3 font-semibold">Dicatat oleh</th>
                            ...
                            <tbody>
                                ...
                                <tr class="border-b border-gray-50 hover:bg-gray-50/60 transition-colors">
                                    ...
                                    <td class="py-3 px-3 text-gray-600 max-w-[240px] truncate" title="{{ $p->keterangan }}">{{ $p->keterangan ?: '-' }}</td>
                                    <td class="py-3 px-3 text-gray-600">{{ $p->user ? $p->user->nama : '-' }}</td>
                                    ...
                                    <td class="py-3 px-3 text-center">
                                        <div class="flex items-center justify-center gap-1">
                                            <button onclick="editPengeluaran({{ $p->id_pengeluaran }}, '{{ $p->tanggal }}', '{{ addslashes($p->kategori) }}', {{ $p->nominal }}, '{{ addslashes($p->keterangan ?? '') }}')"
                                                class="w-7 h-7 inline-flex items-center justify-center text-blue-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="Edit">
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="py-10 text-center text-gray-400 text-[13px]">
        ...
        <div class="relative bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <form action="" method="POST" id="formEdit">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="form-label">Kategori <span class="text-red-500">*</span></label>
                        <input type="text" name="kategori" id="edit_kategori" class="form-input-custom" required>
                    </div>
                    <div>
                        <label class="form-label">Nominal (Rp) <span class="text-red-500">*</span></label>
