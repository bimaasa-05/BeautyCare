...
class AdminPelangganRingkasanSheet implements FromCollection, WithHeadings, WithMapping, WithTitle, WithEvents, WithCustomStartCell
{
    use SheetPengaya;
    ...
    public function __construct(string $startDate, string $endDate)
    {
        ...
        $this->judulSheet = 'LAPORAN PELANGGAN';
    ...
    public function collection()
    {
        ...
        $transaksiPelanggan = \App\Models\Transaksi::whereNotNull('id_pelanggan')
...
class AdminPelangganDataSheet implements FromCollection, WithHeadings, WithMapping, WithTitle, WithEvents, WithCustomStartCell
{
    use SheetPengaya;
    ...
    public function __construct(string $startDate, string $endDate)
    {
        ...
        $this->judulSheet = 'DATA PELANGGAN';
        $this->subtitleSheet = 'Periode ' . date('d M Y', strtotime($this->startDate)) . ' – ' . date('d M Y', strtotime($this->endDate));
        $this->barisHeaderSheet = 3;
