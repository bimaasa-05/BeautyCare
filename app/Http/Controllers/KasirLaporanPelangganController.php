...
use App\Exports\KasirLaporanPelangganExport;
use Barryvdh\DomPDF\Facade\Pdf;
use Maatwebsite\Excel\Facades\Excel;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class KasirLaporanPelangganController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kasir.laporan-pelanggan.index', compact(
    ...
    private function getMembershipDistribution($userId)
    {
        ...
        $data = Membership::leftJoin('pelanggan', 'membership.id_member', '=', 'pelanggan.id_member')
            ->whereIn('pelanggan.id_pelanggan', $pelangganKasir)
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = Pdf::loadView('kasir.laporan-pelanggan.pdf', compact(
            'totalPelanggan', 'pelangganBaru', 'pelangganMember',
            'transaksiPelanggan', 'pelanggan', 'startDate', 'endDate',
            'userName', 'fmt'
        ));

        return $pdf->download('laporan-pelanggan-' . auth()->user()->nama . '-' . date('Y-m-d') . '.pdf');
    }
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(
            new KasirLaporanPelangganExport(auth()->id(), $startDate, $endDate),
            'laporan-pelanggan-' . auth()->user()->nama . '-' . date('Y-m-d') . '.xlsx'
        );
    }
}
